...
%>
 ...
 <span lang="es"><font color="#2D4773" size="2" face="Verdana">$</font> </span>
               <input type="text" name="valorcupon" size="11" value="<%=Session("valorcupon")%>"><span lang="es">&nbsp;
...
set oConn = nothing%>             
      ...
      <p align="center"><b>
      <font color="#2D4773" face="Verdana" size="2"><span lang="es">[ </span></font><a href="ver_plan.asp?periodo=<%=Session("periodo")%>">
      <font face="Verdana" size="2" color="#2D4773">
      <span lang="es">Ver la planilla hasta el momento</span></font></a><font color="#2D4773" face="Verdana" size="2"><span lang="es"> 
      ]</span></font></b></p>
      <hr color="#2D4773" width="400" size="1">
