      ...
      <div align="center">
        ...
        <table border="0" cellpadding="2" style="border-collapse: collapse" bordercolor="#111111" width="699">
          ...
          <tr>
            ...
            <font face="Verdana" size="2" color="#FFFFFF">Código</font></span></b></td>
            <td width="508" align="center" bgcolor="#819FCD"><b><span lang="es">
            <font face="Verdana" size="2" color="#FFFFFF">Descripción</font></span></b></td>
...
%>
          <tr>
            ...
            <td align="center"><span lang="es">
            <font face="Verdana" size="2" color="#2D4773">
            <a href="borra_pres.asp?id=<%=RSArt("id")%>" onclick="return confirm('Si lo borras no podrás recuperarlo. Estás seguro?')><font color="#2D4773">
...
set oConn = nothing%> <hr color="#2D4773" width="400" size="1">         
      ...
      <span lang="es">[ Agregar nueva prestación ]</span></font></b></p>
